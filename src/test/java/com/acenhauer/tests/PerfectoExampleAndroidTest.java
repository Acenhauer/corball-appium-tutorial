 ...
 */
public class PerfectoExampleAndroidTest {
    ...
    @Before public void setUp() throws MalformedURLException {
        ...
        capabilities.setCapability("deviceName", "9203B8D1");
        capabilities.setCapability("autoLaunch", true);
        capabilities.setCapability("fullReset", true);
        capabilities.setCapability("automationName", "Appium");
        capabilities.setCapability("app", "SimpleCalculator.apk");
        driver = new AndroidDriver(new URL("https://juan.appytest@gmail.com:Appytest@appytestcloud.bdigital.org/nexperience/wd/hub"),
            capabilities);
